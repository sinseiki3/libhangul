...
{/* 신세벌 글판 특수기호 확장 배열 */
    ...
    { 0x0000, 0x00B9, 0x2081 }, // 0x21 !:      //¹/0x00B9/₁/0x2081
    { 0x0000, 0x0000, 0x0000 }, // 0x22 ":
    { 0x0000, 0x00B3, 0x2083 }, // 0x23 #:      //³/0x00B3/₃/0x2083
    { 0x0000, 0x2074, 0x2084 }, // 0x24 $:        //⁴/0x2074/₄/0x2084
    { 0x0000, 0x2075, 0x2085 }, // 0x25 %:       //⁵/0x2075/₅/0x2085
    { 0x0000, 0x2077, 0x2087 }, // 0x26 &:      //⁷/0x2077/₇/0x2087
    { 0x326B, 0x266A, 0x266C }, // 0x27 ':   ㉫/0x326B/♪/0x266A/♬/0x266C
    { 0x0000, 0x2079, 0x2089 }, // 0x28 (:     //⁹/0x2079/₉/0x2089
    { 0x0000, 0x2070, 0x2080 }, // 0x29 ):      //⁰/0x2070/₀/0x2080
    { 0x0000, 0x2078, 0x2088 }, // 0x2A *:     //⁸/0x2078/₈/0x2088
    ...
    { 0x2B11, 0x21B0, 0x0000 }, // 0x51 Q:      ⬑/0x2B11/↰/0x21B0//
    { 0x2B0E, 0x21B3, 0x0000 }, // 0x52 R:      ⬎/0x2B0E/↳/0x21B3//
    { 0x0000, 0x0000, 0x2610 }, // 0x53 S:      ////☐/0x2610
    { 0x0000, 0x0000, 0x0000 }, // 0x54 T:        
    { 0x0000, 0x0000, 0x0000 }, // 0x55 U:
    { 0x0000, 0x0000, 0x2612 }, // 0x56 V:      ////☒/0x2612
    { 0x2B0F, 0x21B1, 0x0000 }, // 0x57 W:      ⬏/0x2B0F/↱/0x21B1//
    ...
    { 0x0000, 0x2076, 0x2086 }, // 0x5E ^:    //⁶/0x2076/₆/0x2086
